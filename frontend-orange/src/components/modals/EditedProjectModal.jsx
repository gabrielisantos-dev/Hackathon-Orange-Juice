        ...
        <Modal open={true} onClose={onClose}>
            ...
            >
                <Box sx={{ bgcolor: 'background.paper', p: 4, textAlign: 'center', width: '341px', height: '210px' }}>
                    <Typography variant="h5" component="h2" color='#515255' mb={2} height='48' fontSize='80'>
                    Edição concluída com <br></br> sucesso!
                    </Typography>
...
EditedPostModal.propTypes = {
    onClose: PropTypes.func.isRequired,
};

export default EditedPostModal;